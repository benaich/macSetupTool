...
# Rectangle uses the same default keyboard shortcuts as Spectacle
# Configuration is managed through the app preferences
# No additional defaults write commands needed
